...
package org.apache.spark.blaze.deploy.history
...
import org.apache.spark.blaze.deploy.SparkHadoopUtil
 ...
 * main use case of the HistoryServer is in other org.apache.spark.blaze.deploy modes (e.g. Yarn or Mesos).
 *
