...
prte_odls_base_component_t prte_odls_blaze_component = {
    ...
    .version = {
        ...
        .mca_open_component = prte_odls_blaze_component_open,
        .mca_close_component = prte_odls_blaze_component_close,
        .mca_query_component = prte_odls_blaze_component_query,
    },
    .base_data = {
...
int prte_odls_blaze_component_query(prte_mca_base_module_t **module, int *priority)
{
    ...
    *module = (prte_mca_base_module_t *) &prte_odls_blaze_module;
    return PRTE_SUCCESS;
}
