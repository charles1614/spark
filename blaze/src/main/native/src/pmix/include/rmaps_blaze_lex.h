...
typedef union {
    int ival;
    char *sval;
} prte_rmaps_blaze_value_t;

extern int prte_rmaps_blaze_lex(void);
extern FILE *prte_rmaps_blaze_in;
extern int prte_rmaps_blaze_line;
extern bool prte_rmaps_blaze_done;
extern prte_rmaps_blaze_value_t prte_rmaps_blaze_value;

int prte_rmaps_blaze_wrap(void);
