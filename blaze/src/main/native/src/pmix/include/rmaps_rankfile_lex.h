...
typedef union {
    int ival;
    char *sval;
} prte_rmaps_rankfile_value_t;

extern int prte_rmaps_rankfile_lex(void);
extern FILE *prte_rmaps_rankfile_in;
extern int prte_rmaps_rankfile_line;
extern bool prte_rmaps_rankfile_done;
extern prte_rmaps_rankfile_value_t prte_rmaps_rankfile_value;

int prte_rmaps_rankfile_wrap(void);
