 ...
 *
 * Usage: ./bin/spark-class org.apache.spark.blaze.ui.UIWorkloadGenerator [master] [FIFO|FAIR] [#job set (4 jobs per set)]
 */
// scalastyle:on
private[spark] object UIWorkloadGenerator {
  ...
  def main(args: Array[String]): Unit = {
    if (args.length < 3) {
      ...
      println(
        "Usage: ./bin/spark-class org.apache.spark.blaze.ui.UIWorkloadGenerator " +
