...
sudo cp ./src/pmix/libmca_odls_blaze.so /opt/deps/prrte/lib/prte/mca_odls_blaze.so

# compile spark with hadoop
cd ${spark_home}
mvn -Pnetlib-lgpl -Pyarn -Pkubernetes -Dhadoop.version=3.3.0 -Dscalastyle.skip=true -DskipTests insall 
